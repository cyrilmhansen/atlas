...
Status: active under DEC-061, with private generated bytecode selected by
...
| 5. Consolidation | **In progress (browser complete):** no specialized import or dispatch remains in `app.js`; WASM exports remain differential oracles | five algorithms, no per-algorithm export or `app.js` dispatch branch |
