...
assert.match(source, /import init, \{ AstarMachine, RleMachine, UnionFindMachine, VisualMachine \}/);
...
assert.match(source, /new AstarMachine\(ASTAR_WIDTH, ASTAR_HEIGHT, astarBlocked, astarSource, astarGoal\)/);
...
console.log("Sequence execution stays generated; three distinct demonstrations use bounded domain WASM machines.");
