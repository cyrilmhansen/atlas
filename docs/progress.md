...
- This slice changes layout only. Generated bytecode, the common visual machine
  and `PresentationSpec` have decisions and exit criteria but no implementation
  yet.
