...
node web/tests/insertion_visual_machine.cjs "$node_output/atlas_web.js" "$output_dir/data/atlas.json"
...
node web/tests/astar.cjs "$node_output/atlas_web.js"
...
node web/tests/evidence_handoff.mjs "$output_dir/data/atlas.json"
